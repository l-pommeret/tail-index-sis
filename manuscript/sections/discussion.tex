...
Section~\ref{sec:estimation} shows that (E2) cannot be weakened as
stated for continuous mixtures; whether gaps of order $1/\log n$ are
undetectable by this or any estimator is not settled here. Third, rare favourable configurations:
...
coordinates. The weak-signal model A2 in Section~\ref{sec:simulation}
