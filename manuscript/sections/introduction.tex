...
the projected quantiles and leave their derivation from primitive
assumptions open.
...
Section~\ref{sec:llm} builds a second application, on the maximal token
surprisal of a language model, in which two scale-nuisance clusters
have known status and the screening is calibrated by permutation.
