...
of exact order $1/\log(1/\alpha)$. Exhibiting primitive model classes
whose coordinatewise projections satisfy (E1)--(E3) with useful rates is
left open, together with the derivation of the conditions themselves
from a fully primitive model.
